...
class _HabilidadesPageState extends State<HabilidadesPage> {
  ...
  //Lista de habilidades disponiveis
  final List<String> todasHabilidades = [
    'Comunicação',
    'Trabalho em equipe',
    'Liderança',
    'Organização',
  ...
  //Habilidades filtradas (com na base na busca)
  ...
  void _mostrarDropdown() {
    ...
    habilidadesFiltradas = todasHabilidades; //Mostra tudo inicialmente
  ...
  void _atualizarFiltro(String texto) {
    ...
    setState(() {
      habilidadesFiltradas = todasHabilidades
                  ...
                  onTap: () {
                    setState(() {
                      if (!habilidadesSelecionadas.contains(habilidade)) {
                        habilidadesSelecionadas.add(habilidade); //Adiciona
                      }
            ...
            child: Column(
              children: [
                ...
                Wrap(
                  spacing: 8,
                  runSpacing: 8,
                  children: habilidadesSelecionadas
                      .map(
                        (hab) => Chip(
                          label: Text(hab),
                          ...
                          onDeleted: () {
                            setState(() {
                              habilidadesSelecionadas.remove(hab);
                            });
                          },
                        ),
                      )
